...
# global variables
uni = "AaryaAgarwal" # put your UNI
key_filename = "/Users/AaryaAgarwal/.ssh/id_rsa" # replace with the path to your ssh key locally. You may need to use an absolute path and avoid using "~" to denote your home directory
vm_ex_ips = ['35.193.214.202', '34.28.246.21', '35.222.54.57', '34.132.104.62', '34.133.235.6'] # replace with the external IPs of your VMs, as a list of strings
internal_port = 50001
external_port = 60001
